...
proto.Todo.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    completed: jspb.Message.getFieldWithDefault(msg, 4, false)
  };
 ...
 */
proto.TodoList.prototype.getTodosList = function() {
...
proto.TodoList.prototype.setTodosList = function(value) {
 ...
 * @return {!proto.Todo}
 */
proto.TodoList.prototype.addTodos = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.Todo, opt_index);
};


proto.TodoList.prototype.clearTodosList = function() {
  this.setTodosList([]);
};
